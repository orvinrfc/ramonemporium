...
<html>
<head>
    <title>The Ramon Emporium - Load Emporium Data</title>
...
out.print("<h1>Connecting to Emporium database.</h1><br><br>");

Connection con = DriverManager.getConnection(url, uid, pw);
        
String fileName = "/usr/local/tomcat/webapps/shop/emporiumdb_sql.ddl";
